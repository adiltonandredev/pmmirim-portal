...
export async function Footer({ siteInfo }: { siteInfo?: SiteInfo }) {
  const mapSrc = "https://maps.google.com/maps?q=Pol%C3%ADcia%20Mirim%20de%20Presidente%20M%C3%A9dici&t=&z=17&ie=UTF8&iwloc=&output=embed";
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="flex flex-col h-full">
            ...
            <div className="flex-1 min-h-[160px] bg-white/5 rounded-xl overflow-hidden shadow-lg border border-white/10 group relative">
              <iframe
                title="Localização da Polícia Militar Mirim"
                src={mapSrc}
