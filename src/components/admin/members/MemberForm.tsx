...
export function MemberForm({ member }: MemberFormProps) {
    ...
    const handleSubmit = async (formData: FormData) => {
        ...
        // Lógica para remover a imagem: se o membro tinha foto e agora o preview é null
        if (member?.id && member.image && !preview) {
        ...
        try {
            ...
            if (member?.id) {
                ...
                // Se NÃO clicou no X e NÃO mandou foto nova, mantém a foto atual
