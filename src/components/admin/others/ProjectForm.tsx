...
export function ProjectForm({ project }: ProjectFormProps) {
  ...
  const { feedback, showSuccess, showError, close } = useFeedback()
    ...
    const handleSubmit = async (formData: FormData) => {
        ...
        // Lógica para remover a imagem: se o projeto tinha capa e agora o preview é null
        if (project?.id && project.coverImage && !preview) {
        ...
        try {
            ...
            if (project?.id) {
                ...
                // Se NÃO clicou no X e NÃO mandou foto nova, avisa para manter a foto atual
