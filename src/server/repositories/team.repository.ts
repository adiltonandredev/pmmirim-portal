...
export async function createTeamMemberRecord(data: { name: string; role: string; category: string; bio: string; image: string | null; instagram: string; email: string; order: number }) {
